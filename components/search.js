...
export default function Search() {
  ...
  <View>
   <View style={styles.searchBar}>
    <TextInput style={styles.inputSearch} placeholder="Qual moto você quer pesquisar?" 
    value={inputResult} onChangeText={(texto)=> setInput(texto)}
    />
    ...
    <View>
    <Text style={styles.result}>Exibindo resultados sobre: {resultTxt} </Text>
    </View>
  </View>
  );
}
